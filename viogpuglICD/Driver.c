...
--*/
{
    ...
    attributes.EvtCleanupCallback = viogpuglICDEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           viogpuglICDEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = viogpuglICDCreateDevice(DeviceInit);
...
VOID
viogpuglICDEvtDriverContextCleanup(
